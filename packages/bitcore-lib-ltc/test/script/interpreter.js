...
var script_valid = require('../data/bitgeselld/script_valid');
var script_invalid = require('../data/bitgeselld/script_invalid');
var tx_valid = require('../data/bitgeselld/tx_valid');
var tx_invalid = require('../data/bitgeselld/tx_invalid');

//the script string format used in bitgeselld data tests
...
describe('Interpreter', function() {
  ...
  describe('bitgeselld script evaluation fixtures', function() {
  ...
  describe('bitgeselld transaction evaluation fixtures', function() {
      ...
      set.forEach(function(vector) {
        ...
        it('should pass tx_' + (expected ? '' : 'in') + 'valid vector ' + cc, function() {
          ...
          inputs.forEach(function(input) {
            ...
            if (txoutnum === -1) {
              txoutnum = 0xffffffff; //bitgeselld casts -1 to an unsigned int
            }
