...
var bitgeselljs = require('bitgeselljs-lib');
...
async.series([
  ...
  function(next) {
    ...
    function bitgesellJSTest() {
      block2 = bitgeselljs.Block.fromHex(blockData);
    }
    ...
    suite.add('bitgeselljs', bitgesellJSTest, {maxTime: maxTime});
