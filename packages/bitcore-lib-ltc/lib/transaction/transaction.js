...
/**
 * Retrieve a hexa string that can be used with bitgeselld's CLI interface
 ...
 * * `disableMoreOutputThanInput`: disable checking if the transaction spends more bitgesells than the sum of the input amounts
 * @return {string}
 */
 ...
 *
 * Can receive, as output information, the output of bitgeselld's `listunspent` command,
 ...
 *
 * // From a pay to public key hash output from bitgeselld's listunspent
 ...
 *
 * @see {https://github.com/bitgesell/bips/blob/master/bip-0069.mediawiki}
 * @return {Transaction} this
 */
 ...
 * CheckTransaction in bitgesell core.
 */
...
/**
 * Analogous to bitgeselld's IsCoinBase function in transaction.h
 */
