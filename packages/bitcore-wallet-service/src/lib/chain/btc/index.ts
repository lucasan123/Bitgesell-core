...
export class BtcChain implements IChain {
  ...
  getWalletSendMaxInfo(server, wallet, opts, cb) {
    server.getUtxosForCurrentWallet({}, (err, utxos) => {
      ...
      const MAX_TX_SIZE_IN_KB = Defaults.MAX_TX_SIZE_IN_KB_BGL;
  ...
  // https://bitgesell.stackexchange.com/questions/88226/how-to-calculate-the-size-of-multisig-transaction
