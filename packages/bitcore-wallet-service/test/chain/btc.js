...
describe('Chain BGL', function() {
  ...
  describe('#getEstimatedSize', function() {
    let btc, fromAddress, witnessFromAddress, simpleUtxoWith1BGL, simpleWitnessUtxoWith1BGL, changeAddress, toAddress, privateKey;
...
//      p2shPublicKey3
    ...
    it('1  input p2sh, 2 P2PKH outputs:  ', function() {
      ...
      // Create a similar TX.
      let tx = new BitcoreLib.Transaction();
      tx.from(p2shUtxoWith1BGL, [p2shPublicKey1, p2shPublicKey2], 2)
        .to([{address: toAddress, satoshis: 1e7}, {address: toAddress, satoshis: 1e6}])
        .change(changeAddress)
    ...
    it('1  input p2wpkh, 1 Native Segwit output  ', function() {
      ...
      // https://bitgesell.stackexchange.com/questions/84004/how-do-virtual-size-stripped-size-and-raw-size-compare-between-legacy-address-f
      //
   ...
   it('2  input multisig  p2wsh, 1 native segwit output :  ', function() {
      ...
      // from https://bitgesell.stackexchange.com/questions/88226/how-to-calculate-the-size-of-multisig-transaction
