...
```sh
./wallet-create --name TestWalletBGL --chain BGL --network mainnet
```
...
```sh
./wallet-import --name TestWalletBGL --file ~/Desktop/export.jsonl
```
...
```sh
./wallet-balance --name TestWalletBGL
```

### Balance Checking at Specific Date or Time

```sh
./wallet-balance --name TestWalletBGL --time 01-15-2019
```
...
```sh
./bin/wallet-utxos --name TestWalletBGL
```

### Transaction Creation

```sh
./bin/wallet-tx --addresses '[{"address": "moVf5Rf1r4Dn3URQHumEzvq3vtrFbaRvNr", "satoshis": 2500000000}]' --fee 100 --utxos '[{"txid":"28321f501ce47db1fd40d9ad461624bf9fe6cb581ac0177d17304ff128b86d61","vout":0,"address":"mhwfzHhBdpUKLTzGkUEUpJWa3ipTYZHjF8","script":"21033a3c1aa3fb35e07fe7ff44423c8d378c2d4610ffac8b08c4e6747d7573566937ac","value":5000000000}]' --change "mz21R16FYXfA6G4EJdCrTsduvX9BHHecvv" --name TestWalletBGL --amount 2500000000
```

### Transaction Signing

```sh
./bin/wallet-sign --name TestWalletBGL --tx 0100000001616db828f14f30177d17c01a58cbe69fbf241646add940fdb17de41c501f32280000000000ffffffff0200f90295000000001976a914578237b9848cc709ced0e098417e0494415add1488ac9cf80295000000001976a914caf0ee682de3daa9b3640da1f6d47cc04ce2c99e88ac00000000
```

### Transaction Broadcast

```sh
./bin/wallet-broadcast --name TestWalletBGL --tx 
```

### Paypro Payment

```sh
./bin/wallet-paypro --name TestWalletBGL --payProUri 'https://bitpay.com/i/Dd8q13AnnVyYM7pcMBHfv'
```
