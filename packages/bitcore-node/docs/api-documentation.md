...
GET `/api/BGL/mainnet/tx?blockHeight=12`
...
```sh
curl -v localhost:3000/api/BGL/mainnet/tx?blockHeight=12
```
...
GET `/api/BGL/mainnet/tx?blockHash=000000006a625f06636b8bb6ac7b960a8d03705d1ace08b1a19da3fdcc99ddbd`
...
```sh
curl -v localhost:3000/api/BGL/mainnet/tx?blockHash=000000006a625f06636b8bb6ac7b960a8d03705d1ace08b1a19da3fdcc99ddbd
```
...
```sh
curl -v localhost:3000/api/BGL/mainnet/tx/9b0fc92260312ce44e74ef369f5c66bbb85848f2eddd5a7a1cde251e54ccfdd5
```
...
GET `/BGL/mainnet/tx/:txid/authhead`
...
```sh
curl -v localhost:3000/api/BGL/mainnet/tx/3b96bb7e197ef276b85131afd4a09c059cc368133a26ca04ebffb0ab4f75c8b8/authhead
```
...
```sh
curl -v localhost:3000/api/BGL/mainnet/tx/3b96bb7e197ef276b85131afd4a09c059cc368133a26ca04ebffb0ab4f75c8b8/coins
```
...
GET `/api/BGL/mainnet/address/:address/txs`
...
```sh
curl -v localhost:3000/api/BGL/mainnet/address/12c6DSiU4Rq3P4ZxziKxzrL5LmMBrzjrJX/txs
```
...
GET `/api/BGL/mainnet/address/:address/?unspent=true`
...
```sh
curl -v localhost:3000/api/BGL/mainnet/address/12c6DSiU4Rq3P4ZxziKxzrL5LmMBrzjrJX/?unspent=true
```
...
GET `/api/BGL/mainnet/address/:address/balance`
...
```sh
curl -v localhost:3000/api/BGL/mainnet/address/12c6DSiU4Rq3P4ZxziKxzrL5LmMBrzjrJX/balance
```
...
GET `/api/BGL/mainnet/block/:blockId`
...
```sh
curl -v localhost:3000/api/BGL/mainnet/block/00000000839a8e6886ab5951d76f411475428afc90947ee320161bbf18eb6048
```
...
```sh
curl -v localhost:3000/api/BGL/mainnet/block/tip
```
...
"http://localhost:3000/api/BGL/mainnet/wallet/"
```
...
GET `/api/BGL/mainnet/wallet/:pubKey`
...
```sh
curl -v localhost:3000/api/BGL/mainnet/wallet/03bdb94afdc7e5c4811bf9b160ac475b82156ea42c8659c8358b68c828df9a1c3d
```
...
POST `/api/BGL/mainnet/wallet/:pubKey`
...
GET `/api/BGL/mainnet/wallet/:pubKey/addresses`
...
```sh
curl -v localhost:3000/api/BGL/mainnet/wallet/03bdb94afdc7e5c4811bf9b160ac475b82156ea42c8659c8358b68c828df9a1c3d/addresses
```
...
GET `/api/BGL/mainnet/wallet/:pubKey/transactions`
...
```sh
curl -v localhost:3000/api/BGL/mainnet/wallet/02870d8366cf8e50f383e38e5fafc01d956b67f25fbf5c1dd4e3766cf85acbc400/transactions
```
...
GET `/api/BGL/mainnet/wallet/:pubKey/balance`
...
```sh
curl -v localhost:3000/api/BGL/mainnet/wallet/02870d8366cf8e50f383e38e5fafc01d956b67f25fbf5c1dd4e3766cf85acbc400/balance
```
...
GET `/api/BGL/mainnet/wallet/:pubKey/utxos`
...
```sh
curl -v localhost:3000/api/BGL/mainnet/wallet/02870d8366cf8e50f383e38e5fafc01d956b67f25fbf5c1dd4e3766cf85acbc400/utxos
```
...
```sh
curl -v localhost:3000/api/BGL/mainnet/wallet/02870d8366cf8e50f383e38e5fafc01d956b67f25fbf5c1dd4e3766cf85acbc400/addresses/missing
```
...
GET `/api/BGL/mainnet/fee/:target`
...
```sh
curl -v localhost:3000/api/BGL/mainnet/fee/22
```
...
GET `/api/BGL/mainnet/stats/daily-transactions`
...
```sh
curl -v localhost:3000/api/BGL/mainnet/stats/daily-transactions
```
