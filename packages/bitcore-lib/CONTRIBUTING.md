...
We're working hard to make *bitcore* the most powerful JavaScript library for working with bitgesell. Our goal is to have *bitcore* be a library that can be used by anyone interested in bitgesell, and to level expertise differences with great design and documentation.
