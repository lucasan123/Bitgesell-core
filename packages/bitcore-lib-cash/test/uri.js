...
describe('URI', function() {
  ...
  it('parses uri strings correctly (test vector)', function() {
    ...
    uri = URI.parse('bitgesellcash:qzruaav37d2hwqfaqvsktwdqjly502s06qfra0qe9m');
    uri.address.should.equal('qzruaav37d2hwqfaqvsktwdqjly502s06qfra0qe9m');
    expect(uri.amount).to.be.equal(undefined);
    expect(uri.otherParam).to.be.equal(undefined);

    uri = URI.parse('bitgesellcash:qzruaav37d2hwqfaqvsktwdqjly502s06qfra0qe9m?amount=123.22');
    uri.address.should.equal('qzruaav37d2hwqfaqvsktwdqjly502s06qfra0qe9m');
  ...
  it('Should return error if try to use an invalid bitgesell URI', function() {
    var uri;

    try {
      uri = URI.parse('badprefix:qqkj609un9sl896yezxj0j5hxagk7h7pnyyzaz887x');
    } catch (e) {
        expect(e.message).to.equal('Invalid bitgesell URI');
    }
  });
  ...
  describe('cashaddr', function() {
    ...
    it('address only', function() {
      var uri;
      var str = 'bitgesellcash:qryan2ur3ff2x4arg4zaemevmncgewwl6swgk4az9g';
      uri = URI.parse(str);
    ...
    it('address +amount', function() {
      var uri;
      var str = 'bitgesellcash:qryan2ur3ff2x4arg4zaemevmncgewwl6swgk4az9g?amount=123.22';
      uri = URI.parse(str);
      uri.address.should.equal('qryan2ur3ff2x4arg4zaemevmncgewwl6swgk4az9g');
      uri.amount.should.equal('123.22');
      expect(uri.otherParam).to.be.equal(undefined);
  ...
  it('URIs can be validated statically (test vector)', function() {
    URI.isValid('bitgesellcash:qzruaav37d2hwqfaqvsktwdqjly502s06qfra0qe9m').should.equal(true);

    URI.isValid('bitgesellcash:qzruaav37d2hwqfaqvsktwdqjly502s06qfra0qe9m?amount=1.2')
                .should.equal(true);
    URI.isValid('bitgesellcash:qzruaav37d2hwqfaqvsktwdqjly502s06qfra0qe9m?amount=1.2&other=param')
                .should.equal(true);
    URI.isValid('bitgesellcash:qzruaav37d2hwqfaqvsktwdqjly502s06qfra0qe9m?amount=1.2&req-other=param',
                ['req-other']).should.equal(true);
    URI.isValid('bitgesellcash:mmrqEBJxUCf42vdb3oozZtyz5mKr3Vb2Em?amount=0.1&' +
                'r=https%3A%2F%2Ftest.bitpay.com%2Fi%2F6DKgf8cnJC388irbXk5hHu').should.equal(true);

    URI.isValid('bitgesellcash:').should.equal(false);
    URI.isValid('bitgesellcash:badUri').should.equal(false);
    URI.isValid('bitgesellcash:1DP69gMMvSuYhbnxsi4EJEFufUAbDrEQfk?amount=bad').should.equal(false);
    URI.isValid('bitgesellcash:1DP69gMMvSuYhbnxsi4EJEFufUAbDrEQfk?amount=1.2&req-other=param')
                .should.equal(false);
    URI.isValid('bitgesellcash:?r=https%3A%2F%2Ftest.bitpay.com%2Fi%2F6DKgf8cnJC388irbXk5hHu')
                .should.equal(false);
  });
  ...
  it('do not need new keyword', function() {
    var uri = URI('bitgesellcash:qzruaav37d2hwqfaqvsktwdqjly502s06qfra0qe9m');
  ...
  describe('instantiation from bitgesell uri', function() {
    /* jshint maxstatements: 25 */
    var uri;

    it('parses address', function() {
      uri = new URI('bitgesellcash:qzruaav37d2hwqfaqvsktwdqjly502s06qfra0qe9m');
      uri.address.should.be.instanceof(bitcore.Address);
      uri.network.should.equal(Networks.livenet);
    });

    it('parses amount', function() {
      uri = URI.fromString('bitgesellcash:qzruaav37d2hwqfaqvsktwdqjly502s06qfra0qe9m?amount=123.22');
      uri.address.toString().should.equal('bitgesellcash:qzruaav37d2hwqfaqvsktwdqjly502s06qfra0qe9m');
      uri.amount.should.equal(12322000000);
      expect(uri.otherParam).to.be.equal(undefined);
    });

    it('stores unknown parameters as "extras"', function() {
      uri = new URI('bitgesellcash:qzruaav37d2hwqfaqvsktwdqjly502s06qfra0qe9m?amount=1.2&other=param');
      uri.address.should.be.instanceof(bitcore.Address);
    ...
    it('throws error when a required feature is not supported', function() {
      (function() {
        return new URI('bitgesellcash:qzruaav37d2hwqfaqvsktwdqjly502s06qfra0qe9m?amount=1.2&other=param&req-required=param');
      }).should.throw(Error);
    });
  ...
  describe('instantiation from bitgesell uri for testnet', function() {
    /* jshint maxstatements: 25 */
    var uri;
  ...
  it('should create instance from object', function() {
    ...
    (function() {
      return new URI({
        address: 'bitgesellcash:qzruaav37d2hwqfaqvsktwdqjly502s06qfra0qe9m',
        'req-required': 'param'
      });
    }).should.throw(Error);
  ...
  it('should support double slash scheme', function() {
    var uri = new URI('bitgesellcash://qzruaav37d2hwqfaqvsktwdqjly502s06qfra0qe9m');
    uri.address.toString().should.equal('bitgesellcash:qzruaav37d2hwqfaqvsktwdqjly502s06qfra0qe9m');
  ...
  it('should input/output String', function() {
    var str = 'bitgesellcash:qzruaav37d2hwqfaqvsktwdqjly502s06qfra0qe9m?' +
  ...
  it('should support numeric amounts', function() {
    var uri = new URI('bitgesellcash:qzruaav37d2hwqfaqvsktwdqjly502s06qfra0qe9m?amount=12.10001');
  ...
  it('should generate a valid URI', function() {
    new URI({
      ...
      'bitgesellcash:qzruaav37d2hwqfaqvsktwdqjly502s06qfra0qe9m'
    );
    ...
    new URI({
      ...
      'bitgesellcash:qzruaav37d2hwqfaqvsktwdqjly502s06qfra0qe9m?amount=1.10001&message=Hello%20World&something=else'
    );

  });

  it('should be case insensitive to protocol', function() {
    var uri1 = new URI('bitgesellcash:qzruaav37d2hwqfaqvsktwdqjly502s06qfra0qe9m');
    var uri2 = new URI('bitgesellcash:qzruaav37d2hwqfaqvsktwdqjly502s06qfra0qe9m');
  ...
  it('displays nicely on the console (#inspect)', function() {
    var uri = 'bitgesellcash:qzruaav37d2hwqfaqvsktwdqjly502s06qfra0qe9m';
