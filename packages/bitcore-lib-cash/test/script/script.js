...
describe('Script', function() {
  ...
  describe('#isPushOnly', function() {
    it('should know these scripts are or aren\'t push only', function() {
      ...
      // like bitgeselld, we regard OP_RESERVED as being "push only"
  ...
  describe('#buildPublicKeyHashOut', function() {
    it('should create script from livenet address', function() {
      var address = Address.fromString('bitgesellcash:qrk2ulgf99rm0mjfnr39f2jgjqxjd5kwr5rfyamw2k');
      ...
      s.toAddress().toString().should.equal('bitgesellcash:qrk2ulgf99rm0mjfnr39f2jgjqxjd5kwr5rfyamw2k');
    });
  ...
  describe('getData returns associated data', function() {
    ...
    it('for a P2SH address', function() {
      var address = Address.fromString('bitgesellcash:pzjt8lxnl977xtexlycnl5fyt0al9gcnauyjtqh68n');
  ...
  describe('toAddress', function() {
    ...
    it('for a P2PKH address', function() {
      var stringAddress = 'bitgesellcash:qrk2ulgf99rm0mjfnr39f2jgjqxjd5kwr5rfyamw2k';
      var address = new Address(stringAddress);
      var script = new Script(address);
      script.toAddress().toString().should.equal(stringAddress);
    });
    it('for a P2SH address', function() {
      var stringAddress = 'bitgesellcash:pzjt8lxnl977xtexlycnl5fyt0al9gcnauyjtqh68n';
      var address = new Address(stringAddress);
      var script = new Script(address);
      script.toAddress().toString().should.equal(stringAddress);
    });
    ...
    it('works for p2pkh output', function() {
      ...
      script.toAddress().toString().should.equal('bitgesellcash:qrywzxcwkrf265mzmz20qjyssdql5cdkuyz47850l7');
    });
    it('works for p2pkh input', function() {
      ...
      s2.toAddress().toString().should.equal('bitgesellcash:qprjfgyvctp82eddvwrup69dvggw63afzg0rfyyvtn');
    });
    ...
    it('works for p2sh output', function() {
      ...
      script.toAddress().toString().should.equal('bitgesellcash:pzva9yz34uxzntwtjpqqx36jhwnamce7x5whc9x70h');
    });
    it('works for p2sh input', function() {
      ...
      script.toAddress().toString().should.equal('bitgesellcash:pz30sxmypnge5lv0eyshlt0w5jzu5axu3sl4r37aun');
    });
  ...
  describe('#getSignatureOperationsCount', function() {
    // comes from bitgeselld src/test/sigopcount_tests
