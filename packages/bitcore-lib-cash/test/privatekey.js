...
describe('PrivateKey', function() {
  ...
  describe('#toAddress', function() {
    it('should output this known livenet address correctly', function() {
      ...
      address.toString().should.equal('bitgesellcash:qp3awknl3dz8ezu3rmapff3phnzz95kansf0r3rs4x');
    });
  ...
  it('creates an address as expected from WIF, livenet', function() {
    ...
    privkey.publicKey.toAddress().toString().should.equal('bitgesellcash:qqtv79nz6p246lxt6ja526nhmgdk5qtn9gdc6kt4us');
  });
