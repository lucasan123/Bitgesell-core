...
var validbase58 = require('./data/bitgeselld/base58_keys_valid.json');
var invalidbase58 = require('./data/bitgeselld/base58_keys_invalid.json');
...
describe('Address', function() {
  ...
  var str = 'bitgesellcash:qq7rlg754h903afdtvvy8967zgj5sf5exueg36nyc7';
  ...
  describe('bitgeselld compliance', function() {
  ...
  describe('Cashaddr', function() {
    ...
    //
    var t = [
      ['CTH8H8Zj6DSnXFBKQeDG28ogAS92iS16Bp', 'bitgesellcash:qpm2qsznhks23z7629mms6s4cwef74vcwvy22gdx6a'],
      ['Cazk5ZxnJGY1iYqqTefvo7ZtwLYx3YzjgY', 'bitgesellcash:qr95sy3j9xwd2ap32xkykttr4cvcu7as4y0qverfuy'],
      ['CGZpaFRaJYHqohPJ8BKYvKmxffV2dcmmN9', 'bitgesellcash:qqq3728yw0y47sqn6l2na30mcw6zm78dzqre909m2r'],
      ['HHLN6S9BcP1JLSrMhgD5qe57iVEMFMLCBT', 'bitgesellcash:ppm2qsznhks23z7629mms6s4cwef74vcwvn0h829pq'],
      ['HR3ytsYEpS6XXkWskgfkccqLVPeGdXQ1S8', 'bitgesellcash:pr95sy3j9xwd2ap32xkykttr4cvcu7as4yc93ky28e'],
      ['H6d4PZ12phrMcu4LRDKNjq3QDiaMDz3fUd', 'bitgesellcash:pqq3728yw0y47sqn6l2na30mcw6zm78dzq5ucqzc37'],
    ];
    var i;
  ...
  var PKHLivenet = [
    ...
    'bitgesellcash:qp3awknl3dz8ezu3rmapff3phnzz95kansf0r3rs4x',
  ...
  // livenet p2sh
  var P2SHLivenet = [
    'bitgesellcash:pqv60krfqv3k3lglrcnwtee6ftgwgaykpccr8hujjz',
  ...
  describe('validation', function() {
    ...
    it('isValid returns true on network match on cashaddr', function() {
      Address.isValid('bitgesellcash:qpm2qsznhks23z7629mms6s4cwef74vcwvy22gdx6a', 'mainnet').should.equal(true);
    ...
    it('isValid returns false on network mismatch on cashaddr', function() {
      Address.isValid('bitgesellcash:qpm2qsznhks23z7629mms6s4cwef74vcwvy22gdx6a', 'testnet').should.equal(false);
    ...
    it('addresses with whitespace are validated correctly', function() {
      ...
      should.not.exist(error);
      Address.fromString(ws).toString().should.equal('bitgesellcash:qp3awknl3dz8ezu3rmapff3phnzz95kansf0r3rs4x');
    });
  });
  ...
  describe('encodings', function() {
    ...
    it('should make this address from a compressed pubkey', function() {
      ...
      address.toString().should.equal('bitgesellcash:qp0jaf7jwcf0zlxguv7kcaj05hsxz2lcquxxcxmxtv');
    });
    ...
    it('should make this address from an uncompressed pubkey', function() {
      ...
      a.toString().should.equal('bitgesellcash:qqazje5ucx2l672lc8cundsa5q9lwdm3rcknh40sxg');
      var b = new Address(pubkey, 'livenet', 'pubkeyhash');
      b.toString().should.equal('bitgesellcash:qqazje5ucx2l672lc8cundsa5q9lwdm3rcknh40sxg');
    });
    ...
    describe('from a script', function() {
      ...
      it('should make this address from a p2pkh output script', function() {
        ...
        a.toString().should.equal('bitgesellcash:qrywzxcwkrf265mzmz20qjyssdql5cdkuyz47850l7');
        var b = new Address(s, 'livenet');
        b.toString().should.equal('bitgesellcash:qrywzxcwkrf265mzmz20qjyssdql5cdkuyz47850l7');
      });
      ...
      it('should make this address from a p2sh input script', function() {
        ...
        var a = Address.fromScript(s, 'livenet');
        a.toString().should.equal('bitgesellcash:pznw6jhnz5n3uet7uvrc9r655sm9lfwjpu4ufgvysw');
        var b = new Address(s, 'livenet');
        b.toString().should.equal('bitgesellcash:pznw6jhnz5n3uet7uvrc9r655sm9lfwjpu4ufgvysw');
      });

      it('returns the same address if the script is a pay to public key hash out', function() {
        var address = 'bitgesellcash:qqazje5ucx2l672lc8cundsa5q9lwdm3rcknh40sxg';
      ...
      it('returns the same address if the script is a pay to script hash out', function() {
        var address = 'bitgesellcash:ppkzrtrs0jeheyreg222ekspzpsw7r7qzykvzs4uxh';
  ...
  describe('#inspect', function() {
    it('should output formatted output correctly', function() {
      var address = new Address(str);
      var output = '<Address: bitgesellcash:qq7rlg754h903afdtvvy8967zgj5sf5exueg36nyc7, type: pubkeyhash, network: livenet>';
  ...
  describe('creating a P2SH address from public keys', function() {
    ...
    it('can create an address from a set of public keys', function() {
      ...
      address.toString().should.equal('bitgesellcash:pzdumagr7ru8w46s8alws4lzruv2c75vsuulp7g59n');
  ...
  describe('cashaddr test vectors', function () {
    it('should validate each test vector', function () {
      // vectors from here:
      // https://github.com/bitgesell/bips/blob/master/bip-0173.mediawiki
