...
var sig_canonical = require('../data/bitgeselld/sig_canonical');
var sig_noncanonical = require('../data/bitgeselld/sig_noncanonical');
...
describe('Signature', function() {
  ...
  describe('@isTxDER', function() {
    ...
    describe('bitgeselld fixtures', function() {
