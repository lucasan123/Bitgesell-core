...
/**
 * A bitgesell transaction script. Each transaction's inputs and outputs
 * has a script that is evaluated to validate it's spending.
 *
 * See https://en.bitgesell.it/wiki/Script
 *
 * @constructor
...
Script.buildMultisigIn = function(pubkeys, threshold, signatures, opts) {
  ...
  if (opts.signingMethod === "schnorr" && opts.checkBits) {
    ...
    // Spec according to https://github.com/bitgesellcashorg/bitgesellcash.org/blob/master/spec/2019-11-15-schnorrmultisig.md#scriptsig-size
...
/**
 * Analogous to bitgeselld's FindAndDelete. Find and delete equivalent chunks,
...
/**
 * Comes from bitgeselld's script interpreter CheckMinimalPush function
...
/**
 * Comes from bitgeselld's script DecodeOP_N function
 * @param {number} opcode
...
/**
 * Comes from bitgeselld's script GetSigOpCount(boolean) function
