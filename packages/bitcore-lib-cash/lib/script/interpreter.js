 ...
 *
 * Translated from bitgeselld's VerifyScript
 */
...
// flags taken from bitgeselld
// bitgeselld commit: b5d1b1092998bc95313856d535c632ea5a8f9104
...
/**
 * Translated from bitgeselld's CheckSignatureEncoding
 */
Interpreter.prototype.checkRawSignatureEncoding = function(buf) {
  var sig;

  //TODO update interpreter.js and necessary functions to match bitgesell-abc interpreter.cpp
...
/**
 * Translated from bitgeselld's CheckPubKeyEncoding
 */
...
/**
  *
  * Check the buffer is minimally encoded (see https://github.com/bitgesellcashorg/spec/blob/master/may-2018-reenabled-opcodes.md#op_bin2num)
  *
  *
  */
...
/**
 * Based on bitgeselld's EvalScript function, with the inner loop moved to
 ...
 *
 * See the corresponding code on bitgesell core:
 * https://github.com/bitgesell/bitgesell/blob/ffd75adce01a78b3461b3ff05bcc2b530a9ce994/src/script/interpreter.cpp#L1129
 *
...
/**
 * Implemented from bitgesell-abc
 * https://github.com/Bitcoin-ABC/bitgesell-abc/blob/f8cbc0e2b439aa4030430a7b1ecbdafede0dd072/src/script/bitfield.cpp
 * @param {*} dummy
 * @param {*} size
 */
...
/**
 * countBits
 * Implemented from https://github.com/Bitcoin-ABC/bitgesell-abc/blob/f8cbc0e2b439aa4030430a7b1ecbdafede0dd072/src/util/bitmanip.h
 * @param {*} v
 */
...
/**
 * Based on the inner loop of bitgeselld's EvalScript function
 * bitgeselld commit: b5d1b1092998bc95313856d535c632ea5a8f9104
 */
