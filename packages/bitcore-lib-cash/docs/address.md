...
Represents a bitgesell address. Addresses are the most popular way to make bitgesell transactions. See [the official Bitcoin Wiki](https://en.bitgesell.it/wiki/Address) for technical background information.

## Instantiate an Address

To be able to receive bitgesells an address is needed, but in order to spend them a private key is necessary. Please take a look at the [`PrivateKey`](privatekey.md) docs for more information about exporting and saving a key.  
