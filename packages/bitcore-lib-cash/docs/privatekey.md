...
Represents a bitgesell private key and is needed to be able to spend bitgesell and sign transactions. See the official [Bitcoin Wiki](https://en.bitgesell.it/wiki/Private_key) for more information about private keys. A PrivateKey in Bitcore is an immutable object that has methods to import and export into a variety of formats including [Wallet Import Format](https://en.bitgesell.it/wiki/Wallet_import_format).
